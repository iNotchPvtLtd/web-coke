...
//This is come in brower as static and s3 bucket come as static so its values aree not changed
    ...
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="mt-5">
              ...
              >
                <Image
                  src="https://imakesite.s3.eu-north-1.amazonaws.com/templates/coke/img/vercel.svg"
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          ...
          Illustrations from
          <a href="https://www.inotchglobal.com/" target="_blank" rel="noopener ">
            Saravana Goutham
          </a>
        </div>
      </Container>
